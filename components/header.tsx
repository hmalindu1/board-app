    ...
    <header className="border-b !border-b-gray-300 bg-white px-[24px] ">
      <div className="flex items-center justify-between h-[80px]">
        ...
        <div className="flex items-center gap-[24px]">
            <Button
              className="bg-blue-600 hover:bg-blue-700 text-white gap-[12px] w-[170px] h-[48px]"
            >
          ...
          <div className="flex items-center h-[48px] w-[394px] gap-[48px]">
            ...
            <div className="flex gap-[14px]">
              <Image src={Setting} alt="Logo" className="h-[24px]" />
              <Image src={Bell} alt="Logo" className="h-[24px]" />
